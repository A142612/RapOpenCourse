CLASS ltcl_kl_two_fer DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.
  PRIVATE SECTION.
    DATA cut TYPE REF TO zcl_kl_two_fer.
    METHODS setup.
...
ENDCLASS.
CLASS ltcl_kl_two_fer IMPLEMENTATION.
  METHOD setup.
    cut = NEW zcl_kl_two_fer( ).
  ENDMETHOD.
  METHOD test_empty.
